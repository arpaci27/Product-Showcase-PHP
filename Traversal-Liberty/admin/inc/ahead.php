...
<html lang="en">
    <head>
        ...
        <title><?php echo $sayfa?> - EaslyTrade</title>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link  <?php echo $sayfa=="Anasayfa"?"active":"" ?>" href="users.php" data-bs-toggle=""aria-expanded="false" aria-controls="collapseLayouts">
                               ...
                               Users
                            </a></a><div class="sb-sidenav-menu-heading">Categories</div>
                            <a class="nav-link  <?php echo $sayfa=="Anasayfa"?"active":"" ?>" href="products.php" data-bs-toggle=""aria-expanded="false" aria-controls="collapseLayouts">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-list"></i></div> Categories
                             </a></a><div class="sb-sidenav-menu-heading">Products</div>
                            </a><a class="nav-link  <?php echo $sayfa=="Anasayfa"?"active":"" ?>" href="productdetails.php" data-bs-toggle=""aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-shirtsinbulk"></i></div>
                             Products
                            </a>
                         ...
                         <!--    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            ...
                            </div><div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
